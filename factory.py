...
from server.exceptions import not_found_exception_handler, conflict_exception_handler, internal_exception_handler
...
def create_app() -> FastAPI:
    app: FastAPI = FastAPI(exception_handlers={
        ...
        InternalError: internal_exception_handler
    })
